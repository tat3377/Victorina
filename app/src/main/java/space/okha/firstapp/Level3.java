...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // вызов диалогового окга в начале игры
        ...
        dialogfon.setBackgroundResource(R.drawable.fon_roses);
        ...
        numLeft = random.nextInt(16);//генерирум случайное число от 0 до 16
        ...
        numRight = random.nextInt(16);//генерируем случайное число от 0-9
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                 //если коснулся картинки начало
                  ...
                  //если отпустил палец начало
                    ...
                    if (count==20){
                        //ВЫХОД ИЗ УРОВНЯ
                        //параметр level будет запоминать и передавать цифры на каждом уровне в переменную level
                        ...
                        if(level >3 ){
                            ...
                            editor.putInt("Level",4);//уровень пройден и мы пишем цифру следующего уровня
                            editor.commit();
                        }
                        ...
                        numRight = random.nextInt(16);//генерируем случайное число от 0-16
